        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="col-span-1 lg:col-span-2">
              ...
              {currentUser && (
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Sayar Basu</h3>
                  
                  {/* Flashcards in landscape format */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {['FastAPI', 'Streamlit', 'Flask', 'Gradio', 'Colab Notebooks', 'VSCode'].map((skill, index) => (
                              <span key={index} className="px-3 py-1.5 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 rounded-full text-sm border border-red-100 dark:border-red-800/50 hover:shadow-sm transition-all">{skill}</span>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {['Manim (for math animations)', 'MoviePy', 'UDP/Socket Programming (Java)', 'JSON/REST APIs', 'Custom CAS engines'].map((skill, index) => (
                              <span key={index} className="px-3 py-1.5 bg-pink-50 dark:bg-pink-900/20 text-pink-700 dark:text-pink-300 rounded-full text-sm border border-pink-100 dark:border-pink-800/50 hover:shadow-sm transition-all">{skill}</span>
                            ))}
                          </div>
                        </div>
                      </div>
